 ...
 */
#include "ssd1306.h"
#define my_hi2c hi2c3

extern I2C_HandleTypeDef my_hi2c;
/* Write command */
...
uint8_t SSD1306_Init(void) {
	...
	if (HAL_I2C_IsDeviceReady(&my_hi2c, SSD1306_I2C_ADDR, 1, 20000) != HAL_OK) {
		/* Return false */
		return 0;
	}
...
for(i = 0; i < count; i++)
dt[i+1] = data[i];
HAL_I2C_Master_Transmit(&my_hi2c, address, dt, count+1, 10);
}
...
void ssd1306_I2C_Write(uint8_t address, uint8_t reg, uint8_t data) {
	...
	dt[0] = reg;
	dt[1] = data;
	HAL_I2C_Master_Transmit(&my_hi2c, address, dt, 2, 10);
}
